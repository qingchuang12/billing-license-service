...
> **[已归档 2026-09-07]** 本 plan 为 2026-08-23 的历史快照，原位于 `doc/plan-v1.0-launch.md`（旧文档目录）。其全部任务卡已被后续 plan 覆盖完成：
...
> - 卡0/卡5 基线验证与发布收尾 → `docs/archive/plan-v2.2-readiness.md`（v2.2）结论：可发布候选
